...
/**
 * Created by chrisrenner on 4/22/15.
 */
public class BluetoothService {
    ...
    /**
     * Start the ConnectThread to initiate a connection to remove device
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    // TO DO HERE - SEND RECEIVED BYES TO ACTIVITY
